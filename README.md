...
la ce pompe se realizează alimentările, prin ce pistol de pompă se face o alimentare, ce produse se vând în magazin, 
ce bonuri fiscale au fost emise, ce angajați lucrează în anumite ture și ce aprovizionări au fost făcute de la furnizori.
...
și aprovizionarea stației de la diverși furnizori, atât pentru produsele din magazin, cât și pentru tipurile de carburant.
...
16. [APROVIZIONARE](#entitatea-aprovizionare) - Reprezintă intrările de marfă în stație de la furnizori;
...
18. [ARTICOL_APROV_CARBURANT](#entitatea-articol-aprov-carburant) - Tabel asociativ între APROVIZIONARE și TIP_CARBURANT pentru a înregistra carburanții aprovizionați.
...
O aprovizionare poate conține mai multe tipuri de carburant, iar un tip de carburant poate apărea în mai multe aprovizionări.
-- cardinalități; relație de tip many-to-many, rezolvată prin ARTICOL_APROV_CARBURANT
